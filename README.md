...
| **GRAPH popups**              | Clicking a transition opens its LAD/FBD logic network; clicking a step opens its action table (Interlock / Event / Qualifier / Action); hovering shows step/transition comments.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
